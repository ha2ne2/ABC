...
using static ABC142.abc142_d.Cin;
using static ABC142.abc142_d.Util;
using Pair = ABC142.abc142_d.VTuple<long, long>;
...
namespace ABC142.abc142_d
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            long B = rl;
            long gcd = GCD(A, B);
            long ans = PrimeFactorize(gcd).Count + 1;
