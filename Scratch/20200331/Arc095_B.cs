...
using static _20200331.Arc095_B.Cin;
using static _20200331.Arc095_B.Util;
using Pair = _20200331.Arc095_B.VTuple<long, long>;
using Graph = System.Collections.Generic.List<System.Collections.Generic.List<long>>;
using System.Text;

namespace _20200331
{
    public class Arc095_B
    {
        public static void Main(string[] args)
        {
            ...
            if (Abs(A[ok] - val) < Abs(A[ng] - val))
            {
                Console.WriteLine(string.Format("{0} {1}", a, A[ok]));
            }
            else
            {
                Console.WriteLine(string.Format("{0} {1}", a, A[ng]));
            }
