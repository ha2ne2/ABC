...
using static _20200410.abc079_c.Cin;
using static _20200410.abc079_c.Util;
...
namespace _20200410.abc079_c
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Func<int, int, int>[] ops = new Func<int, int, int>[2];
            ops[0] = (a, b) => a + b;
            ops[1] = (a, b) => a - b;
            ...
            for (int i = 0; i < 2; i++)
            {
                for (int j = 0; j < 2; j++)
                {
                    for (int k = 0; k < 2; k++)
                    {
                        if (ops[k](ops[j](ops[i](A, B), C), D) == 7)
                        {
                            string ans = string.Format("{0}{1}{2}{3}{4}{5}{6}=7",
