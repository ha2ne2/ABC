...
using static Judge_Update_202004.C.Cin;
using static Judge_Update_202004.C.Util;
using Pair = Judge_Update_202004.C.VTuple<long, long>;
...
namespace Judge_Update_202004
{
    public class C
    {
        ...
        {
            // a[left] < a[left+1] ‚ð–ž‚½‚·Å‘å‚Ìleft‚ð’T‚·
            ...
            // a[left] < a[right] ‚ð–ž‚½‚·Å‘å‚Ìright‚ð’T‚·
            ...
            // Œã‚ë‚ð‘S•”“ü‚ê‘Ö‚¦‚éB“ü‚ê‘Ö‚¦Œã‚Í a[left] > a[left+1] < a[left+2] < ... < a[length-1] ‚Æ‚¢‚¤•s“™Ž®‚ª¬‚è—§‚ÂB
            left++;
