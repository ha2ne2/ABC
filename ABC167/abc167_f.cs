...
using static ABC167.abc167_f.Cin;
using static ABC167.abc167_f.Util;
using Pair = ABC167.abc167_f.VTuple<long, long>;
...
namespace ABC167.abc167_f
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            for (int i = 1; i < N; i++)
            {
                now = new Pair(Abs(now.Item1 - P[i].Item2), Abs(now.Item2 - P[i].Item1));
            }

            if (now.Item1 == 0 && now.Item2 == 0)
            {
