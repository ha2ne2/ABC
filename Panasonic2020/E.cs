...
using static Panasonic2020.E.Cin;
using static Panasonic2020.E.Util;
using Pair = Panasonic2020.E.VTuple<long, long>;
...
namespace Panasonic2020
{
    public class E
    {
        //public static long solve(string a, string b, string c)
        //{
        ...
        //        if (ok)
        //        {
        //            ans = a.Length + b.Length - j;
        //            next += b.Substring(j, b.Length - j);
        //            next.Replace('?', '_');
        //        }
        //    }
        ...
        //        bool ok = true;
        //        int j = 0;
        //        for (j = 0; j < c.Length || i + j < next.Length; j++)
        //        {
        //            if (next[i + j] != c[j] || next[i + j] != '?')
        //            {
        //                ok = false;
        //                break;
        //            }
        ...
        public static void Main(string[] args)
        {
            ...
            long ans = INF;
            //ChMin(ref ans, solve(a, b, c));
            //ChMin(ref ans, solve(a, c, b));
            //ChMin(ref ans, solve(b, a, c));
            //ChMin(ref ans, solve(b, c, a));
            //ChMin(ref ans, solve(c, a, b));
            //ChMin(ref ans, solve(c, b, a));
