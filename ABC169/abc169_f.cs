...
using static ABC169.abc169_f.Cin;
using static ABC169.abc169_f.Util;
using Pair = ABC169.abc169_f.VTuple<long, long>;
...
namespace ABC169.abc169_f
{
    public class Program
    {
        ...
        private class Hoge
        {
            public Hoge Left { get; set; }
            public Hoge LeftTop { get; set; }
            public int[] Data { get; set; } = new int[3001];
